...
set output 'graph_hash_functions_time_lookup.pdf'
...
plot 'Hash function KRHash.dat' using 2:4 title "KRHash" with linespoints ls 1,\
     'Hash function ELFHash.dat' using 2:4 title "ELFHash" with linespoints ls 2,\
     'Hash function jen.dat' using 2:4 title "jen" with linespoints ls 3,\
     'Hash function djb2.dat' using 2:4 title "djb2" with linespoints ls 4,\
     'Hash function fnvHash.dat' using 2:4 title "fnvHash" with linespoints ls 5
